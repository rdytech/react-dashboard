...
},{"./Dashboard.js":168}],2:[function(require,module,exports){
...
},{"./lib/bar":6,"./lib/doughnut":8,"./lib/line":9,"./lib/pie":10,"./lib/polar-area":11,"./lib/radar":12}],6:[function(require,module,exports){
...
JobReady.Dashboard = {
    addNumberWidget: function addNumberWidget(widgetContainerId, title, url, icon, pollInterval) {
        React.render(React.createElement(NumberWidget, { title: title, url: url, widgetIcon: icon, pollInterval: pollInterval }), document.getElementById(widgetContainerId));
    },
    addListWidget: function addListWidget(widgetContainerId, title, url, icon, pollInterval) {
        React.render(React.createElement(ListWidget, { title: title, url: url, widgetIcon: icon, pollInterval: pollInterval }), document.getElementById(widgetContainerId));
    },
    addPieChart: function addPieChart(widgetContainerId, title, icon, chartData, chartOptions) {
        React.render(React.createElement(PieChartWidget, { title: title, widgetIcon: icon, chartOptions: chartOptions, chartData: chartData }), document.getElementById(widgetContainerId));
    }
};

window.JobReady = JobReady;

},{"./widgets/ListWidget":169,"./widgets/NumberWidget":171,"./widgets/PieChartWidget":172,"react":167}],169:[function(require,module,exports){
"use strict";
...
var ListWidget = React.createClass({
    ...
    render: function render() {
        ...
        var listItems = this.state.data.items.map(function (item) {
            return React.createElement(ListWidgetItem, { title: item.name, url: item.url, tooltip: item.tooltip });
        });
...
},{"./ListWidgetItem":170,"jquery":4,"react":167}],170:[function(require,module,exports){
"use strict";
...
},{"jquery":4,"react":167}],172:[function(require,module,exports){
"use strict";
...
},{"jquery":4,"react":167,"react-chartjs":5}]},{},[1]);
