...
JobReady.Dashboard = {
    addWidget: function (widgetContainer, title, url, icon, pollInterval) {
        var $widget = $(widgetContainer);
        React.render(
            React.createElement(Widget, {title: title, url: url, widgetIcon: icon, pollInterval: pollInterval}),
            document.getElementById($widget.attr('id')));
    }
};
...
},{"./Widget":149,"react":147}],149:[function(require,module,exports){
var React = require('react');
        ...
        return (
            React.createElement("div", {className: "panel panel-default"}, 
                ...
                React.createElement("div", {className: "panel-body"}, 
                    React.createElement(WidgetList, {items: this.state.data.items})
                )
            )
        );
    }
...
},{"./WidgetList":150,"react":147}],150:[function(require,module,exports){
var React = require('react');
...
},{"./WidgetListItem":151,"react":147}],151:[function(require,module,exports){
var React = require('react');
